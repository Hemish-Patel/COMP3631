...
class colourIdentifier(Node):
    ...
    def callback(self, data):
        ...
        hsv_red_higher1 = np.array([0 + self.sensitivity//2, 255, 255])
        
        hsv_red_lower2 = np.array([180 - self.sensitivity//2, 100, 100])
        hsv_red_higher2 = np.array([180, 255, 255])
        ...
        red_mask1 = cv2.inRange(hsv_image, hsv_red_lower1, hsv_red_higher1)
        red_mask2 = cv2.inRange(hsv_image, hsv_red_lower2, hsv_red_higher2)
